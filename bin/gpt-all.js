...
async function main() {
  try {
    ...
    await callOpenAI(diff, 'Create a conventional commit message for the following changes');

    console.log(chalk.yellow('\n-------------------- PR DESCRIPTION --------------------\n'));
    await callOpenAI(diff, 'Create a PR description for the following changes');
